document.addEventListener('DOMContentLoaded', function () {
    ...
    // --- CONFIGURACIÓN ---
    const IMAGENES_PLIEGOS = [
        'pliego1.jpg', 'pliego2.jpg', 'pliego3.jpg', 'pliego4.jpg', 'pliego5.jpg'
    ];
    ...
    zoomBtn.addEventListener('click', toggleZoom); // Añadimos el nuevo listener
});